 ...
 */
router.route('/')
    .post(topicController_1.createTopic)
    .get(topicController_1.getTopics);
/**
 * @swagger
 * /topics/{id}:
 * get:
 ...
 */
router.route('/:id')
    .get(topicController_1.getTopicById)
    .put(topicController_1.updateTopic)
    .delete(topicController_1.deleteTopic);
