...
const uploadMainCategory = (0, multerConfig_1.default)('main-categories');
 ...
 */
router.route('/')
    .post(uploadMainCategory.single('mainCategoryImage'), mainCategoryController_1.createMainCategory) // Use the common Multer instance
    .get(mainCategoryController_1.getMainCategories);
/**
 * @swagger
 * /main-categories/{id}:
 * get:
 ...
 */
router.route('/:id')
    .get(mainCategoryController_1.getMainCategoryById)
    .put(uploadMainCategory.single('mainCategoryImage'), mainCategoryController_1.updateMainCategory) // Use the common Multer instance
    .delete(mainCategoryController_1.deleteMainCategory);
