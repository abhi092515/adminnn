 ...
 */
router.post('/track-class-view', trackClassView);
 ...
 *         description: Server error
 */
router.get('/class/:classId', getClassViews);
 ...
 *         description: Server error
 */
router.get('/analytics/:classId', getClassViewAnalytics);
 ...
 *         description: Server error
 */
router.get('/user/:userId/history', getUserViewHistory);
